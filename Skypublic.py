...
cl = LINETCR.LINE()
cl.login(token='EpFFIilvh5XKvGSlIng4.V5Kns0dIiMAgkfsSwJGeDa.72NJNvwYAwDSfQ1MfJNoO8yxfUx6jnEBFYagWZBhzq8=')
cl.loginResult()
...
â• â‚âž£ Sky:gcreator
â• â‚âž£ Sky:geinfo
â• â•â•â•â•â•â•[STEAL]â•â•â•â•â•â•â•
â• â‚âž£ Sky:spp 
â• â‚âž£ Sky:scover 
â• â‚âž£ Sky:name 
â• â‚âž£ Sky:bio 
...
â• â‚âž£ Sky:info 
â• â‚âž£ Sky:profile 
â• â•â•â•â•â•â•[SELF]â•â•â•â•â•â•â•
â• â‚âž£ Sky:temanlist
â• â‚âž£ Sky:invitecreator
â• â‚âž£ Sky:gn:
â• â‚âž£ Sky:bye
â• â‚âž£ Spbot/Sp
â• â‚âž£ Respon
...
â• â‚âž£ Sky:ps:[Text]
â• â‚âž£ Sky:music:[Judul-Penyayi]
â• â‚âž£ Sky:lirik:[Judul-Penyayi]
â• â‚âž£ Sky:musrik:[Judul-Penyayi]
â• â‚âž£ Sky:ig:[Unsername Ig]
â• â‚âž£ Sky:checkig:[Unsername Ig]
â• â‚âž£ Sky:apakah:[Text]
â• â‚âž£ Sky:apakah:[Text]
â• â‚âž£ Sky:hari:[Text]
â• â‚âž£ Sky:berapa:[Text]
â• â‚âž£ Sky:berapakah:[Text]
â• â‚âž£ Sky:ytlink:[Text]
â• â‚âž£ Sky:ytvideo:[Text]
â• â‚âž£ Sky:ytsearch:[Text]
â• â‚âž£ Sky:image:[Text]
â• â•â•â•â•â•â•[TRANSLATE]â•â•â•â•â•â•â•
â• â‚âž£ Sky:tr-id:En=ID
â• â‚âž£ Sky:tr-en:ID=En
â• â‚âž£ Sky:tr-th:ID=TH
â• â•â•â•â•â•â•[GROUP]â•â•â•â•â•â•â•
â• â‚âž£ Sky:cancel
â• â‚âž£ Sky:recover
â• â‚âž£ Sky:ag
â• â‚âž£ Sky:cancelall
â• â‚âž£ Sky:getqr
â• â‚âž£ Sky:pgroup:[Name Group]
â• â‚âž£ Sky:glist
â• â‚âž£ Sky:gimage
â• â‚âž£ Sky:ugroup
â• â‚âž£ Sky:memlist
â• â‚âž£ Sky:welcome on/off
â• â‚âž£ Sky:read on/off
â• â‚âž£ Sky:sider on/off
â• â‚âž£ Sky:buka on/off
â• â‚âž£ Sky:tutup on/off
â• â‚âž£ Sky:simi onoff
â• â‚âž£ Spam:[Text]
â• â‚âž£ Sky:invite:[Mid]
â• â‚âž£ Sky:invite:
â• â‚âž£ Sky:like on
â• â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
â•‘Creator Public
...
â• â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
â•‘COMMAND KHUSUS ADMIN
â•‘Admin Menu
â• â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
â•‘Jika Ada Yang Error
â•‘Harap Lapor Ke Contact
â•‘Di atas Sekian Terimakasih
â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
"""
...
â• â‚âž£ Sky:glist
â• â‚âž£ Sky:glistmid
â• â‚âž£ Details group: (Gid)
â• â‚âž£ Invitemeto: (Gid)
â• â‚âž£ Sky:removechat
â• â‚âž£ Sky:qr on/off
â• â‚âž£ Sky:Atkick on/off
â• â‚âž£ Sky:Atcancel on/off
â• â‚âž£ Sky:invite on/off
â• â‚âž£ Sky:atjoin on/off
â• â‚âž£ Sky:respon on/off
â• â‚âž£ Sky:responkick on/off
â• â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
â•‘â˜… SKYLINE TEAM â˜…
â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
...
def cms(string, commands): #/XXX, >XXX, ;XXX, ^XXX, %XXX, $XXX...
    tex = ["+","@","/",">",";","^","%","$","Ã¯Â¼Â¾","Ã£â€šÂµÃ£Æ’â€ Ã£Æ’Â©:","Ã£â€šÂµÃ£Æ’â€ Ã£Æ’Â©:","Ã£â€šÂµÃ£Æ’â€ Ã£Æ’Â©Ã¯Â¼Å¡","Ã£â€šÂµÃ£Æ’â€ Ã£Æ’Â©Ã¯Â¼Å¡"]
    for texX in tex:
                        ...
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        random.choice(KAC).sendText(op.param1, "Haii " + "Ã¢ËœÅ¾ " + nick[0] + " Ã¢ËœÅ“" + "\nNgintip Aja Niih. . .\nChat Kek Idiih (-__-)   ")
                                    else:
                                        random.choice(KAC).sendText(op.param1, "Haii " + "Ã¢ËœÅ¾ " + nick[1] + " Ã¢ËœÅ“" + "\nBetah Banget Jadi Penonton. . .\nChat Napa (-__-)   ")
                                else:
                                    random.choice(KAC).sendText(op.param1, "Haii " + "Ã¢ËœÅ¾ " + Name + " Ã¢ËœÅ“" + "\nNgapain Kak Ngintip Aja???\nSini Gabung Chat...   ")
                        else:
                            pass
                    else:
                        pass
	 ...
	 if wait["Ghost"] == True:
		...
		try:
		    if msg.from_ in Creator:
			        ...
			        cl.sendText(msg.to,"ã€ŒBerhasil Bergabung -> ["+ h +"] <- Groupã€")
			    else:
			        pass
		    else:
		        cl.sendText(msg.to,"ã€ŒSpecial Command Untuk Ownerã€")
		except Exception as e:
		...
		if msg.from_ in Creator:
                    for i in gid:
                        h = cl.getGroup(i).name
		        if h == ng:
			    cl.sendText(i,"ã€ŒBot Di Paksa Keluar Oleh Ownerã€\n\nã€ŒInvite Kembali Ke Group Andaã€")
		            cl.leaveGroup(i)
			    cl.sendText(msg.to,"ã€ŒBerhasil Keluar -> ["+ h +"] <- Groupã€")
			else:
			    pass
		else:
		    cl.sendText(msg.to,"ã€ŒSpecial Command Untuk Ownerã€")
		...
		gid = cl.getGroupIdsJoined()
                if msg.from_ in Creator:
		    for i in gid:
			cl.sendText(i,"ã€ŒBot Di Pakasa Pergi Oleh Ownerã€\n\nã€ŒInvite Kembali Ke Group Andaã€")
		        cl.leaveGroup(i)
		    cl.sendText(msg.to,"ã€ŒSukses Leaveall Groupã€")
		else:
		    cl.sendText(msg.to,"ã€ŒSpecial Command Untuk Ownerã€")
                ...
                if msg.toType == 2:
                    ...
                    if X.invitee is not None:
                        ...
                        cl.sendText(msg.to,"ã€ŒTidak Ada Pending Di Group Iniã€")
                else:
                ...
                if msg.toType == 2:
                    ...
                    cl.updateGroup(X)
                    cl.sendText(msg.to,"ã€ŒLink Sudah Terbukaã€")
                else:
                    cl.sendText(msg.to,"ã€ŒLink Sudah Terbukaã€")
                ...
                if msg.toType == 2:
                    ...
                    cl.updateGroup(X)
                    cl.sendText(msg.to,"ã€ŒLink Sudah Tertutupã€")
		...
		if msg.from_ in admin:
                    ...
                    cl.sendText(msg.to,"ã€ŒAuto Join Sudah Aktiveã€")
		else:
		    cl.sendText(msg.to,"ã€ŒHanya Admin & Owner Yang Bisa Pakaiã€")

            elif msg.text in ["Sky:Atjoin off"]:
		if msg.from_ in admin:
                    wait["AutoJoin"] = False
                    cl.sendText(msg.to,"ã€ŒAuto Join Sudah Non Aktiveã€")
		else:
		    cl.sendText(msg.to,"ã€ŒHanya Admin & Owner Yang Bisa Pakaiã€")
		...
		if msg.from_ in admin:
                    ...
                    wait["AutoJoin"] = False
                    cl.sendText(msg.to,"ã€ŒAuto Join Cancel Sudah Aktiveã€")
		else:
		    cl.sendText(msg.to,"ã€ŒHanya Admin & Owner Yang Bisa Pakaiã€")
		...
		if msg.from_ in admin:
                    wait["AutoJoinCancel"] = False
                    cl.sendText(msg.to,"ã€ŒAuto Join Cancel Sudah Non Aktiveã€")
		else:
		    cl.sendText(msg.to,"ã€ŒHanya Admin & Owner Yang Bisa Pakaiã€")		    
		...
		if msg.from_ in admin:
                    ...
                    cl.sendText(msg.to,"ã€ŒAuto Respon Sudah Aktiveã€")
		else:
		    cl.sendText(msg.to,"ã€ŒHanya Admin & Owner Yang Bisa Pakaiã€")
		...
		if msg.from_ in admin:
                    ...
                    cl.sendText(msg.to,"ã€ŒAuto Respon Sudah Non Aktiveã€")
		else:
		    cl.sendText(msg.to,"ã€ŒHanya Admin & Owner Yang Bisa Pakaiã€")	
		...
		if msg.from_ in admin:
                    ...
                    wait["detectMention"] = False
                    cl.sendText(msg.to,"ã€ŒAuto Respon Kick Sudah Aktiveã€")
		else:
		    cl.sendText(msg.to,"ã€ŒHanya Admin & Owner Yang Bisa Pakaiã€")
		...
		if msg.from_ in admin:
                    wait["kickMention"] = False                    
                    cl.sendText(msg.to,"ã€ŒAuto Respon Kick Sudah Non Aktiveã€")
		else:
		    cl.sendText(msg.to,"ã€ŒHanya Admin & Owner Yang Bisa Pakaiã€")			  
		...
		if msg.from_ in admin:
	     ...
	     if msg.from_ in admin:	        
                ...
                cl.sendText(msg.to,"ã€ŒAuto Cancel Sudah Aktiveã€")
		print wait["AutoCancel"]
	     ...
	     if msg.from_ in admin:	        
                ...
                cl.sendText(msg.to,"ã€ŒAuto Cancel Sudah Non Aktiveã€")
		print wait["AutoCancel"]
	     else:
		    cl.sendText(msg.to,"ã€ŒHanya Admin & Owner Yang Bisa Pakaiã€")	
	     ...
	     if msg.from_ in admin:	        
                wait["joinkick"] = True
                wait["Sambutan"] = False
                cl.sendText(msg.to,"ã€ŒJoin Kick Sudah Aktiveã€")
	     else:
		    cl.sendText(msg.to,"ã€ŒHanya Admin & Owner Yang Bisa Pakaiã€")		
	     ...
	     if msg.from_ in admin:	        
                wait["joinkick"] = False
                cl.sendText(msg.to,"ã€ŒJoin Kick Sudah Non Aktiveã€")
	     else:
		    cl.sendText(msg.to,"ã€ŒHanya Admin & Owner Yang Bisa Pakaiã€")	
	     ...
	     if msg.from_ in admin:	        
                ...
                cl.sendText(msg.to,"ã€ŒProtection Invite Sudah Aktiveã€")
	     else:
		    cl.sendText(msg.to,"ã€ŒHanya Admin & Owner Yang Bisa Pakaiã€")		
	     ...
	     if msg.from_ in admin:	        
                ...
                cl.sendText(msg.to,"ã€ŒProtection Invite Sudah Non Aktiveã€")
	     else:
		    cl.sendText(msg.to,"ã€ŒHanya Admin & Owner Yang Bisa Pakaiã€")		    
	     ...
	     if msg.from_ in admin:	        
	        wait["Qr"][msg.to] = True
	        wait["Qron"] = True
	    	cl.sendText(msg.to,"ã€ŒProtection Link Group Aktiveã€")
		print wait["Qr"]	    	
	     else:
		    cl.sendText(msg.to,"ã€ŒHanya Admin & Owner Yang Bisa Pakaiã€")	    	
	     ...
	     if msg.from_ in admin:	        
	    	...
	    	wait["Qron"] = False
	    	cl.sendText(msg.to,"ã€ŒProtection Link Group Non Aktiveã€")
		print wait["Qr"]	    	
	     else:
		    cl.sendText(msg.to,"ã€ŒHanya Admin & Owner Yang Bisa Pakaiã€")	    	
	     ...
	     if msg.from_ in admin:	        
                ...
                cl.sendText(msg.to,"ã€ŒAuto Kick Sudah Aktiveã€")
		print wait["AutoKick"]
	     else:
		    cl.sendText(msg.to,"ã€ŒHanya Admin & Owner Yang Bisa Pakaiã€")		
	     ...
	     if msg.from_ in admin:	        
                ...
                cl.sendText(msg.to,"ã€ŒAuto Kick Sudah Non Aktiveã€")
		print wait["AutoKick"]
	     else:
		    cl.sendText(msg.to,"ã€ŒHanya Admin & Owner Yang Bisa Pakaiã€")	
	     ...
	     if msg.from_ in admin:	        
                wait["Ghost"] = True
                cl.sendText(msg.to,"ã€ŒAuto Kill Sudah Aktiveã€")
	     else:
		    cl.sendText(msg.to,"ã€ŒHanya Admin & Owner Yang Bisa Pakaiã€")		
	     ...
	     if msg.from_ in admin:	        
                wait["Ghost"] = False
                cl.sendText(msg.to,"ã€ŒAuto Kill Sudah Non Aktiveã€")
	     else:
		    cl.sendText(msg.to,"ã€ŒHanya Admin & Owner Yang Bisa Pakaiã€")	     
		...
		if msg.from_ in admin:
                    ...
                    wait["Qron"] = True
                    wait["Ghost"] = True     
                    cl.sendText(msg.to,"ã€ŒProtection Group Sudah Aktiveã€")
		    print wait["AutoCancel"]
		    print wait["AutoKick"]
		    print wait["Qr"]
		else:
		...
		if msg.from_ in admin:
                    ...
                    wait["Qron"] = False
                    wait["Ghost"] = False 
                    cl.sendText(msg.to,"ã€ŒProtection Group Sudah Non Aktiveã€")
		    print wait["AutoCancel"]
		    print wait["AutoKick"]
		    print wait["Qr"]
		else:                    
#		else:
		    cl.sendText(msg.to,"ã€ŒHanya Admin & Owner Yang Bisa Pakaiã€")
                ...
                wait["Contact"] = True
                cl.sendText(msg.to,"ã€ŒContact Sudah Aktiveã€")

            elif msg.text in ["Sky:contact off"]:
                wait["Contact"] = False
                cl.sendText(msg.to,"ã€ŒContact Sudah Non Aktiveã€")
                

            elif msg.text in ["Sky:read on"]:
                wait["alwaysRead"] = True
                cl.sendText(msg.to,"ã€ŒAuto Read Sudah Aktiveã€")

            elif msg.text in ["Sky:read off"]:
                wait["alwaysRead"] = False
                cl.sendText(msg.to,"ã€ŒAuto Read Sudah Non Aktiveã€")                


            elif msg.text in ["Sky:welcome on"]:
                if wait["Sambutan"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ã€ŒAuto Welcome Sudah Aktiveã€")
                else:
                    wait["Sambutan"] = True
                    wait["joinkick"] = False
                    if wait["lang"] == "JP":
                ...
                if wait["Sambutan"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ã€ŒAuto Welcome Sudah Non Aktiveã€")
                else:
                    wait["Sambutan"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"ã€ŒAuto Welcome Sudah Non Aktiveã€")
                ...
                wait["Sider"] = True
                cl.sendText(msg.to,"ã€ŒCheck Sider Sudah Aktiveã€")
                
            elif "Sky:sider off" in msg.text:
                if msg.to in cctv['point']:
                    cctv['cyduk'][msg.to]=False
                    wait["Sider"] = False
                    cl.sendText(msg.to, "ã€ŒCheck Sider Sudah Non Aktiveã€")
                else:
                    cl.sendText(msg.to, "ã€ŒSorry Kamu Belum Aktive kan [Sky:sider on] Aktive kan Dulu Baru Bisa Pakai Command [Sky:sider offã€")                         


            elif msg.text in ["Status"]:
                md = ""
		if wait["Sambutan"] == True: md+="âœ¦ Welcome ã€ŒONã€\n"
		else:md+="âœ¦ Welcome ã€ŒOFFã€\n"		
		if wait["AutoJoin"] == True: md+="âœ¦ Atjoin  ã€ŒONã€\n"
                else: md +="âœ¦ Atjoin ã€ŒOFFã€\n"
		if wait["AutoJoinCancel"] == True: md+="âœ¦ Atjoin cancel ã€ŒONã€\n"
                else: md +="âœ¦ Atjoin cancel ã€ŒOFFã€\n"                
		if wait["Leave"] == True: md+="âœ¦ Leave ã€ŒONã€\n"
                else: md +="âœ¦ Leave ã€ŒOFFã€\n"                
		if wait["Contact"] == True: md+="âœ¦ Contact ã€ŒONã€\n"
		else: md+="âœ¦ Contact ã€ŒOFFã€\n"
		if wait["alwaysRead"] == True: md+="âœ¦ Atread ã€ŒONã€\n"
		else:md+="âœ¦ Atread ã€ŒOFFã€\n"				
		if wait["Sider"] == True: md+="âœ¦ Atsider ã€ŒONã€\n"
		else:md+="âœ¦ Atsider ã€ŒOFFã€\n"	
		if wait["Simi"] == True: md+="âœ¦ Simisimi ã€ŒONã€\n"
		else:md+="âœ¦ Simisimi ã€ŒOFFã€\n"		
                cl.sendText(msg.to,"ã€ŒSTATUS BOTS PUBLICã€\n"+md+"ã€ŒBOT PUBLICã€")
                ...
                cl.sendText(msg.to, "Ã¢Ëœâ€ Checkpoint CheckedÃ¢Ëœâ€ ")
                print "Setview"
	        ...
	        dataResult, timeSeen, contacts, userList, timelist, recheckData = [], [], [], [], [], []
                with open('dataSeen/'+msg.to+'.txt','r') as rr:
                    ...
                    for v in range(len(recheckData)):
                        ...
                        pass
                    if len(dataResult) > 0:
                        tukang = "Ã¢â€¢â€Ã¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢Â\nÃ¢â€¢â€˜         Ã¢Ëœâ€ Ã¢ËœÅ¾ LIST VIEWERS Ã¢ËœÅ“Ã¢Ëœâ€ \nÃ¢â€¢Â Ã¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢Â\nÃ¢â€¢Â Ã¢Å¾Â©"
                        grp = '\nÃ¢â€¢Â Ã¢Å¾Â© '.join(str(f) for f in dataResult)
                        total = '\nÃ¢â€¢Â Ã¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢Â\nÃ¢â€¢Â Ã¢Å¾Â© Total %i Viewers (%s)' % (len(dataResult), datetime.now().strftime('%H:%M:%S')) + "\nÃ¢â€¢Å¡Ã¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢Â"
                        cl.sendText(msg.to, "%s %s %s" % (tukang, grp, total))
                        subprocess.Popen("echo '' > dataSeen/"+msg.to+".txt", shell=True, stdout=subprocess.PIPE)
                        cl.sendText(msg.to, "Ã¢Ëœâ€ Auto CheckpointÃ¢Ëœâ€ ")                        
                    else:
                        cl.sendText(msg.to, "Ã¢Ëœâ€ Belum Ada ViewersÃ¢Ëœâ€ ")
                    print "Viewseen"
		...
		if msg.from_ in admin:	 	        
		    ...
		    cl.sendText(msg.to, "ã€ŒJumlah Member Telah Di Setã€=  "+jml)
		    ...
		    cl.sendText(msg.to,"ã€ŒAuto Add Teman Aktiveã€")
                ...
                wait["likeOn"] = True
                cl.sendText(msg.to,"ã€ŒAuto Like Sudah Aktiveã€")                
		...
		cl.sendText(msg.to,"ã€ŒSukses Recoverã€")
                ...
                if msg.toType == 2:
                    ...
                    cl.sendText(msg.to,"ã€ŒSet Name Group Sudah Di Gantiã€")
		...
		cl.sendText(msg.to,"ã€ŒBOT PUBLIC VERSI V3ã€\n\nã€ŒProsses To Up V4ã€")
		...
		cl.sendText(msg.to, "Progress...")
              ...
              if msg.from_ in admin:
                ...
                if msg.from_ in admin:
                    wait["blacklist"] = {}
                    cl.sendText(msg.to,"Ã£Æ’Â½( ^Ãâ€°^)Ã¯Â¾â€°Ã¢â€â€ Ã¢Ââ€°Unbanned All SuccessÃ¢Ââ€° Ã¢â€Â") 

            elif msg.text.lower() in ["bot","chucky"]:
                cl.sendText(msg.to,"Apa Manggil~Manggil Aku!?") 
                cl.sendText(msg.to,"Ã¢Ëœâ€ Ketik Ã¢ËœÅ¾HelpÃ¢ËœÅ“ Untuk BantuanÃ¢Ëœâ€ ") 
              ...
              if msg.from_ in Creator:
                ...
                try:
					...
					for song in data:
						...
						cl.sendText(msg.to, "Title : " + song[0] + "\nLength : " + song[1] + "\nã€ŒProsess Link Downloadã€ : " + song[4])
#						cl.sendText(msg.to, "Lagu " + song[0] + "\nSedang Di Prosses... Tunggu Sebentar ^_^ ")
						cl.sendAudioWithURL(msg.to,abc)
						cl.sendText(msg.to, "ã€ŒDone Music Yang Anda Inginkanã€ " + song[0])
                ...
                cl.sendAudio(msg.to,"hasil.mp3")
                    ...
                    beb = "Hi Sayang Ã°Å¸ËœËœ " +cl.getContact(msg.from_).displayName + " Ã´â‚¬Â¸â€šÃ´â‚¬â€ â€¡starry heartÃ´ÂÂ¿Â¿"
                ...
                cl.sendText(msg.to,"ã€ŒProsess To Searchã€")
                cl.sendText(msg.to,"Title : "+tob+"\nã€ŒSourceã€ : ã€ŒGoogle Playã€\nã€ŒLinkã€ : https://play.google.com/store/search?q=" + tob)
              ...
              if msg.from_ in Creator:
                ...
                middd = "ã€ŒYOUR NAMEã€  " +cl.getContact(msg.from_).displayName + "\nã€ŒYOUR MIDã€ " +msg.from_
                ...
                wait["Simi"] = True
                cl.sendText(msg.to,"ã€ŒSimi Simi Sudah Aktiveã€")
                
            elif msg.text in ["Sky:simi off"]:
                settings["simiSimi"][msg.to] = False
                wait["Simi"] = False
                cl.sendText(msg.to,"ã€ŒSimi Simi Sudah Non Aktiveã€")
                ...
                num=1
                msgs="ã€ŒMember List Groupã€"
                for ids in group:
                    msgs+="\n[%i] %s" % (num, ids.displayName)
                    num=(num+1)
                msgs+="\nã€ŒMember List Groupã€\n\nã€ŒTotal Membersã€ : %i" % len(group)
                cl.sendText(msg.to, msgs)
...
#              if msg.from_ in admin:
                ...
                try:
                    cl.sendText(msg.to, "ã€ŒYour Nameã€\n" + contact.displayName)
                except:
                    cl.sendText(msg.to, "ã€ŒYour Nameã€\n" + contact.displayName)
                ...
                cu = cl.channel.getCover(key1)
                try:
                    cl.sendText(msg.to, "ã€ŒYour Statusã€" + contact.statusMessage)
                except:
                    cl.sendText(msg.to, "ã€ŒYour Statusã€\n" + contact.statusMessage)


            elif msg.text.lower() == 'runtime':
                eltime = time.time() - mulai
                van = "ã€ŒBot Sudah Berjalanã€ \n"+waktu(eltime)
                ...
                cl.sendText(msg.to,"ã€ŒINFOã€\n"+"ã€ŒDate Of Brithã€ : "+lahir+"\nã€ŒAgeã€ : "+usia+"\nã€ŒUltahã€ : "+ultah+"\nã€ŒZodiakã€ : "+zodiak+"\nã€ŒDone Infoã€")
                ...
                cl.sendText(msg.to, "ã€ŒSedang Prosessã€")                    
                gid = cl.getGroupIdsJoined()
                h = ""
                for i in gid:
                    h += "â‡¨" + "%s\n" % (cl.getGroup(i).name +" ~> ["+str(len(cl.getGroup(i).members))+"]")
                cl.sendText(msg.to,"ã€ŒLIST GROUPã€\n" + h + " " + "\nã€ŒTOTAL GROUPã€ =" +" ["+str(len(gid))+"]")
